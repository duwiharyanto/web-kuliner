<template>
    <div class="keranjang">
        <NavbarVue :updatekeranjang="keranjangs"></NavbarVue>
        <div class="container">
            <!-- breadcrumb -->
            <div class="row mt-4">
                <div class="col">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(keranjang, index) in keranjangs" :key="keranjang.id">
                                    <th>{{ index + 1 }}</th>
                                    <td>
                                        <img :src="'../assets/images/' + keranjang.products.gambar"
    ...
    methods: {
        ...
        hapusKeranjang(id) {
            axios.delete('http://localhost:3000/keranjangs/' + id)
                .then(() => {
                    this.$toast.error("Hapus berhasil", {
                        type: "error",
                        position: "top-right",
                        duration: 3000,
                        dismissible: true,
            ...
            if (this.pesan.nama && this.pesan.noMeja) {
                ...
                axios.post('http://localhost:3000/pesanans', this.pesan)
                    .then(() => {
                        ...
                        this.$toast.success("Pesanan berhasil ditambahkan", {
                            type: "success",
                            position: "top-right",
                            duration: 3000,
                            dismissible: true,
                ...
                this.$toast.error("nama dan meja harus diisi", {
                    type: "error",
                    position: "top-right",
                    duration: 3000,
                    dismissible: true,
